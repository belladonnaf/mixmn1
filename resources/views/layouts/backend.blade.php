                    ...
                    <div>
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn btn-dual" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="d-none d-sm-inline-block">Member</span>
...
<?php 
$sql = " select count(id) cnt from mp3_stream_set where user_id = ? ";
$login_id = request()->session()->get('login_id');
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-0" aria-labelledby="page-header-notifications-dropdown">
                                ...
                                <ul class="nav-items my-2">
                                    ...
                                    <li>
                                        <a class="text-dark media py-2" href="/pages/how-to-fix-player">
                                            <div class="mx-3">
                ...
                <div class="content py-0">
                    <div class="row font-size-sm">
                        <div class="col-sm-6 order-sm-1 text-center text-sm-left">
                          MIXmn1 &copy; <span data-toggle="year-copy">2018</span>
                        </div>
                    </div>
                </div>
            </footer>
