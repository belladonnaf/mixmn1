	...
	@endif			                
			                ...
			                <div class="mr-3">
			                    <p class="text-white font-size-h3 font-w300 mb-0">
			                       <span class="rank rank-{{($k+1)}}">{{($k+1)}}</span> <span class="album-info">{{$row['album_info]}}</span>
			                    </p>
			                </div>
			            </div>
			        </a>
...
@foreach ($second_arr as $k=>$row)
  ...
  @if( $row['image'] > '' )
	...
	@endif			                
			                ...
			                <div class="mr-3">
			                    <p class="text-white font-size-h3 font-w300 mb-0">
			                       <span class="rank rank-{{($k+11)}}">{{($k+11)}}</span> <span class="album-info">{{$row['album_info]}}</span>
			                    </p>
			                </div>
			            </div>
			        </a>
...
@foreach ($third_arr as $k=>$row)
	...
	@endif			                
			                ...
			                <div class="mr-3">
			                    <p class="text-white font-size-h3 font-w300 mb-0">
			                       <span class="rank rank-{{($k+21)}}">{{($k+21)}}</span> <span class="album-info">{{$row['album_info]}}</span>
			                    </p>
			                </div>
			            </div>
			        </a>
