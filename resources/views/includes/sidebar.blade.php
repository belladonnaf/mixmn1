                ...
                <div class="tab-pane pull-x fade fade-up show active" id="so-settings" role="tabpanel">
                    <div class="block mb-0">
                        ...
                        <div class="block-content block-content-full">
                            <div class="row gutters-tiny text-center">
                                ...
                                <div class="col-6 mb-1">
                                    <a class="d-block py-3 text-white font-size-sm font-w600 bg-default" href="#" @click="setUIFav(1)">
                                        Recommended
                                    </a>
                                </div>
                                <div class="col-6 mb-1">
                                    <a class="d-block py-3 text-white font-size-sm font-w600 bg-xeco" href="#" @click="setUIFav(2)">
                                        Archives
                                    </a>
                                </div>
                                <div class="col-6 mb-1">
                                    <a class="d-block py-3 text-white font-size-sm font-w600 bg-xsmooth" href="#" @click="setUIFav(3)">
                                        Search
                                    </a>
                                </div>
                                <div class="col-6 mb-1">
                                    <a class="d-block py-3 text-white font-size-sm font-w600 bg-xinspire" href="#" @click="setUIFav(4)">
                                        Favorites
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="block-content block-content-full">
                            <div class="row gutters-tiny text-center">
                                <div class="col-6 mb-1">
                                    <a class="d-block py-3 bg-body-dark font-w600 text-dark" href="#" @click="setGenreFav(1)">EDM Music</a>
                                </div>
                                <div class="col-6 mb-1">
                                    <a class="d-block py-3 bg-body-dark font-w600 text-dark" href="#" @click="setGenreFav(2)">Hip Hop</a>
                                </div>
                                <div class="col-6 mb-1">
                                    <a class="d-block py-3 bg-body-dark font-w600 text-dark" href="#" @click="setGenreFav(3)">Easy Listening</a>
                                </div>
                                <div class="col-6 mb-1">
                                    <a class="d-block py-3 bg-body-dark font-w600 text-dark" href="#" @click="setGenreFav(4)">Classical</a>
                                </div>
                                <div class="col-6 mb-1">
                                    <a class="d-block py-3 bg-body-dark font-w600 text-dark" href="#" @click="setGenreFav(5)">Pop</a>
                                </div>
                                <div class="col-6 mb-1">
                                    <a class="d-block py-3 bg-body-dark font-w600 text-dark" href="#" @click="setGenreFav(6)">Kpop</a>
                                </div>
                                <div class="col-6 mb-1">
                                    <a class="d-block py-3 bg-body-dark font-w600 text-dark" href="#" @click="setGenreFav(7)">Chanson</a>
                                </div>
                                <div class="col-6 mb-1">
                                    <a class="d-block py-3 bg-body-dark font-w600 text-dark" href="#" @click="setGenreFav(8)">Hardcore</a>
                                </div>
                            </div>
                        </div>
                        <!-- END Header -->
